 ...
 */
public class PlaylistDeleteAsyncTask extends AsyncTask<String, Void, Integer> {
    ...
    public PlaylistDeleteAsyncTask(Context context, Playlist playlist, PlaylistAdapter adapter) {
    ...
    protected void onPostExecute(Integer stt) {
        ...
        if(stt == HttpURLConnection.HTTP_OK){
            Instance.myPlaylits.remove(playlist);
            Toast.makeText(context, "Remove playlist success", Toast.LENGTH_SHORT).show();
